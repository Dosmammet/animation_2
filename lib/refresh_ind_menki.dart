...
class RefreshIndicatorMenki extends StatefulWidget {
  ...
  @override
  RefreshIndicatorMenkiState createState() => RefreshIndicatorMenkiState();
}

/// Contains the state for a [RefreshIndicatorMenki]. This class can be used to
/// programmatically show the refresh indicator, see the [show] method.
class RefreshIndicatorMenkiState extends State<RefreshIndicatorMenki>
    with TickerProviderStateMixin<RefreshIndicatorMenki> {
  ...
  @override
  void didUpdateWidget(covariant RefreshIndicatorMenki oldWidget) {
